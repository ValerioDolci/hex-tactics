"""
Train v8 — D3 tweak: armatura pesante RD 9→12 (specialist).
...
OUT_DIR = Path("/tmp/hex_tactics_dqn_v8_d3")
...
class CharBuilderCallback(BaseCallback):
    def __init__(self, eval_freq=20_000, snapshot_freq=50_000, n_eval_ep=5, snapshot_pool=None):
        super().__init__()
...
def main():
    ...
    callback = CharBuilderCallback(
        eval_freq=20_000, snapshot_freq=50_000,
