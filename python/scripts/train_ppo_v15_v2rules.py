"""Train v15 — MaskablePPO con regole V2 (imp variabile + asta universale).

Differenze da v14:
- Impedimento ora morde la VARIABILE invece della FISSA (cambio strutturale combat).
- Asta zona controllo universale (TUTTE le armi melee con reach >=1).
- Pugnale/spada/mazza/ascia hanno reach 1 esplicito (era undefined).

Riduco total_timesteps a 150k (vs 500k v14) per training più rapido.
"""
...
OUT_DIR = Path("/tmp/hex_tactics_ppo_v15")
