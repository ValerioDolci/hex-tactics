...
Output: /tmp/hex_tactics_dqn_multi_v4/
"""
...
OUT_DIR = Path("/tmp/hex_tactics_dqn_multi_v4")
...
def main() -> None:
    ...
    env = HexTacticsEnv(preset_a="random", preset_b="random", max_rounds=30, seed=12345)
